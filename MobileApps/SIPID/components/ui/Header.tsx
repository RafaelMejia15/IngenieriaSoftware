...
export function Header({ title, showBack = true, showHub = true }: HeaderProps) {
  ...
  return (
    <View className="flex-row items-center justify-between px-6 py-4 bg-zinc-950 border-b border-zinc-800">
      ...
      {showHub && (
        <Pressable
          ...
          className="bg-purple-600/20 border border-purple-500/40 px-4 py-2 rounded-full active:bg-purple-600/40 hover:bg-purple-600/30"
        >
